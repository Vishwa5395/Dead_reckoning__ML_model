...
for cent_thresh in [1.5, 1.8, 2.0, 2.2]:
    for cent_gain in [0.5, 0.7, 0.9, 1.0, 1.2]:
        for speed_decay in [0.6, 0.8, 1.0, 1.2]:
            drifts = []
...
print(f"OPTIMAL: thresh={best_params[0]:.1f}, gain={best_params[1]:.1f}, decay={best_params[2]:.1f} -> {best_drift:.2f} m")
