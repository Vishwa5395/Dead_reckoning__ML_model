...
for target_outage, s in [(9, 91), (10, 101)]:
    ...
    for k in range(10):
        ...
        print(f"k={k:02d} | v_gt={x_gps[cur]:5.2f}, v_p={xr:5.2f}, diff={xr-x_gps[cur]:+5.2f} | HeadErr={head_err_deg:5.2f}° | Drift={drift:5.2f}m")
